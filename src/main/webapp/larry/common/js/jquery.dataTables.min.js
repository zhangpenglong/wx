(function($, window, document, undefined) {
    var DataTable = function(oInit) {
        function _fnAddColumn(oSettings, nTh) {
            ...
            var oCol = $.extend({},
                DataTable.models.oColumn, oDefaults, {
        ...
        function _fnAddData(oSettings, aDataSupplied) {
            var oCol;
            var aDataIn = ($.isArray(aDataSupplied)) ? aDataSupplied.slice() : $.extend(true, {},
                aDataSupplied);
        ...
        function _fnFeatureHtmlFilter(oSettings) {
            ...
            jqFilter.attr("aria-controls", oSettings.sTableId).bind("keypress.DT",
                function(e) {
                    if (e.keyCode == 13) {
                        return false
                    }
        ...
        function _fnLanguageCompat(oLanguage) {
            ...
            if (!oLanguage.sEmptyTable && oLanguage.sZeroRecords && oDefaults.sEmptyTable === "<p style='text-align: center'>对不起，没有找到相关数据信息！</p>") {
            ...
            if (!oSettings.aanFeatures.p) {
                oSettings.aoDrawCallback.push({
                    fn: function(oSettings) {
                        DataTable.ext.oPagination[oSettings.sPaginationType].fnUpdate(oSettings,
                            function(oSettings) {
                                _fnCalculateEnd(oSettings);
                                _fnDraw(oSettings)
                            })
        ...
        this.fnUpdate = function(mData, mRow, iColumn, bRedraw, bAction) {
            ...
            if (oSettings.__fnUpdateDeep === undefined && $.isArray(mData) && typeof mData === "object") {
                ...
                if (oSettings.__fnUpdateDeep === undefined && mData !== null && typeof mData === "object") {
    ...
    DataTable.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "对不起，没有找到相关数据！",
            sInfo: "当前从 _START_ 到 _END_ 共 _TOTAL_ 条记录",
            sInfoEmpty: "当前从 0 到 0 共 0 条记录",
    ...
    $.extend(DataTable.ext.oPagination, {
        ...
        full_numbers: {
            fnInit: function(oSettings, nPaging, fnCallbackDraw) {
                ...
                $(nPaging).append('<a  tabindex="' + oSettings.iTabIndex + '" class="' + oClasses.sPageButton + " " + oClasses.sPageFirst + '" title="' + oLang.sFirst + '"></a><a  tabindex="' + oSettings.iTabIndex + '" class="' + oClasses.sPageButton + " " + oClasses.sPagePrevious + '" title="' + oLang.sPrevious + '"></a><span></span><a tabindex="' + oSettings.iTabIndex + '" class="' + oClasses.sPageButton + " " + oClasses.sPageNext + '" title="' + oLang.sNext + ' "></a><a tabindex="' + oSettings.iTabIndex + '" class="' + oClasses.sPageButton + " " + oClasses.sPageLast + '" title="' + oLang.sLast + ' "></a>');
                var els = $("a", nPaging);
                var nFirst = els[0],
                    nPrev = els[1],
                    nNext = els[2],
